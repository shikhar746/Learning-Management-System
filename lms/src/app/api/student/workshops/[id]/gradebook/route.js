  ...
  try {
    ...
    const gradebookRows = workshop.assignments.map((assignment) => {
      ...
      if (sub && sub.isGradePublished && sub.totalScore !== null) {
        ...
        totalEarnedMarks += sub.totalScore
        gradedCount++
      }
      ...
      return {
        ...
        submission: sub
          ? {
              ...
              totalScore: isGraded ? sub.totalScore : null,
              functionalityScore: isGraded ? sub.functionalityScore : null,
              qualityScore: isGraded ? sub.qualityScore : null,
    ...
    const overallPercentage = totalMaxMarks > 0 ? Math.round((totalEarnedMarks / totalMaxMarks) * 100) : 0
